...
const translations = {
  en: {
    ...
    contact_form_description_hint: "Optional",
    contact_form_submit: "Submit",
    contact_form_submitting: "Submitting…",
    contact_form_success: "Thank you — your message was sent.",
  ...
  ar: {
    ...
    contact_form_description_hint: "اختياري",
    contact_form_submit: "تقديم",
    contact_form_submitting: "جاري التقديم…",
    contact_form_success: "شكراً لك — تم إرسال رسالتك.",
